...
awful.util.tagnames =
	{ " react ", " react ", " react ", " react ", " react ", " react ", " react ", " react ", " react " }
...
globalkeys = my_table.join(
	...
	awful.key({ modkey }, "d", function()
		awful.spawn.with_shell("~/.config/rofi/launchers/colorful/launcher.sh")
	end, { description = "rofi", group = "applications" }),

	awful.key({ modkey }, "i", function()
		awful.spawn.with_shell("ani-cli --rofi")
	end, { description = "rofi", group = "applications" }),

	awful.key({ modkey, "Shift" }, "i", function()
		awful.spawn.with_shell("ani-cli -c --rofi")
	end, { description = "rofi", group = "applications" }),
