...
globalkeys = my_table.join(
    -- My applications
    awful.key({ modkey }, "d", function () awful.spawn.with_shell("~/.config/rofi/launchers/colorful/launcher.sh") end,
        {description = "rofi" , group = "applications" }),

    awful.key({ modkey }, "i", function () awful.spawn.with_shell("ani-cli --rofi") end,
        {description = "rofi" , group = "applications" }),
    ...
    awful.key({ modkey, "Shift"   }, "e",  function () awful.spawn.with_shell( 'killall awesome' ) end,
